...
def main():
    ...
    # better_draw_circles(rg.Point(100, 20), 10)
    # better_draw_circles(rg.Point(50, 100), 30)

    # even_better_draw_circles(rg.Point(100, 100), 30, 15, 'blue', 10)
    # even_better_draw_circles(rg.Point(200, 50), 10, 30, 'red', 2)

    even_better_draw_circles(rg.Point(0, 0), 5, 50, 'red', 2)
    even_better_draw_circles(rg.Point(50, 50), 10, 60, 'orange', 4)
    even_better_draw_circles(rg.Point(100, 100), 15, 70, 'yellow', 6)
    even_better_draw_circles(rg.Point(150, 150), 20, 80, 'green', 8)
    even_better_draw_circles(rg.Point(200, 200), 25, 90, 'blue', 10)
    even_better_draw_circles(rg.Point(250, 250), 30, 100, 'purple', 12)
...
def better_draw_circles(point, x):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(x * k)  # Radius 15, 30, 45, 60, ...
